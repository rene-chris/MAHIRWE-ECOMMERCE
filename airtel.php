...
<head>
    ...
    <title>Pay with Airtel Money - MAHIRWE SMART BUSINESS</title>
...
<body>
    ...
    <div class="container main-content">
        <h1 class="main-title gradient-text animate-slide-in">Pay with Airtel Money</h1>
        <div class="card animate-slide-in">
            ...
            <ol class="instructions-list">
                <li class="animate-row" style="animation-delay: 0s;">Dial *100# on your Airtel phone</li>
                <li class="animate-row" style="animation-delay: 0.1s;">Select option 3: Send Money</li>
                <li class="animate-row" style="animation-delay: 0.2s;">Enter recipient number: <strong>0738813118</strong></li>
    ...
    <script>
        ...
        document.getElementById('paymentForm').addEventListener('submit', (e) => {
            ...
            formData.append('payment_method', 'Airtel Money');
            ...
            .catch(() => showNotification('Error processing payment', 'error'));
        });
